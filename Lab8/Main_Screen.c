...
/********************************************************/ 
/*     Initialize_LCD_Screen(): Setup LCD screen        */ 
/********************************************************/ 
...
/*****************************************************/ 
/* update_LCD_color(char, char): Update color of LCD */ 
/*****************************************************/
...
/*************************************************************/ 
/* update_LCD_PED_Count(char, char): Pedestrian countdown    */ 
/*************************************************************/ 
void update_LCD_PED_Count(char direction, char count)
{
   switch (direction)
   {
      case 0:       
		...
		PORTD = (PORTD & mask_TFT) | count;			// output count to 7-segment
		DP = 1;										// turn off DP
      ...
      case 1:
        ...
        PORTD = (PORTD & mask_TFT) | count;           // Output count to 7-segment
        DP = 1;                                      // Turn off DP
        drawtext(PED_Count_X, PED_EW_Count_Y, PED_EW_Count, EW_Color, ST7735_BLACK, TS_2);  // Display counter
        break; 		
   }
...
/*************************************************************/ 
/* update_LCD_count(char, char): Traffic signal countdown    */ 
/*************************************************************/
...
/*************************************************************/ 
/*          update_LCD_misc(): Refresh misc data fields      */ 
/*************************************************************/ 
void update_LCD_misc()
{
    ...
    if (SW_NSLT == 0)  SW_NSLT_Txt[0] = '0';  else SW_NSLT_Txt[0] = '1';  //code was added here
